...
VG_IMAGES = '/home/liang/neural-motifs/data/vg/VG_100K_total'
...
class ModelConfig(object):
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-val_size', dest='val_size', help='val size to use (if 0 we wont use val)', type=int, default=200)
